...
import org.openhab.binding.sunsetwx.internal.json.ErrorResponse;
import org.openhab.binding.sunsetwx.internal.json.FeatureContainer;
import org.openhab.binding.sunsetwx.internal.json.LocationFeature;
import org.openhab.binding.sunsetwx.internal.json.LocationProperties;
import org.openhab.binding.sunsetwx.internal.json.LoginError;
import org.openhab.binding.sunsetwx.internal.json.LoginSuccess;
import org.openhab.binding.sunsetwx.internal.json.QualityFeature;
import org.openhab.binding.sunsetwx.internal.json.QualityProperties;
...
public class SunsetWxSession {
    ...
    public final String URL_DOMAIN = "https://sunburst.sunsetwx.com/";
    public final String URL_VERSION = "v1/";
    public final String URL_LOGIN = "login";
    public final String URL_QUALITY = "quality";
    public final String URL_LOCATION = "location";

    private final int TIMEOUT_LOGIN = 10000;
    private final int TIMEOUT_OTHER = 20000;

    private final String USER_AGENT = "openHAB SunsetWx Binding";
    ...
    private boolean parseLoginResponse(String response) {
        ...
        try {
            ...
            loginResponse = g.fromJson(response, LoginSuccess.class);
        ...
        if (loginResponse.getMessage() == null) {
            ...
            try {
                ...
                loginErrorResponse = g.fromJson(response, LoginError.class);
            } catch (JsonSyntaxException e) {
    ...
    private void parseQualityResponse(String response) {
        ...
        try {
            fc = g.fromJson(response, FeatureContainer.class);
        } catch (JsonSyntaxException e) {
     ...
     */
    private void updateChannels(String response, FeatureContainer fc) {
     ...
     */
    private void updateQualityChannels(FeatureContainer fc) {
        ...
        for (QualityFeature f : fc.features) {
            QualityProperties p = f.properties;
     ...
     */
    private void updateDateChannels(QualityProperties props) {
    ...
    private void parseLocationResponse(String response) {
        ...
        try {
            lf = g.fromJson(trimmedResponse, LocationFeature.class);
        } catch (JsonSyntaxException e) {
    ...
    private String getError(String response) {
        ...
        try {
            ...
            errorResponse = g.fromJson(response, ErrorResponse.class);
        } catch (JsonSyntaxException e) {
